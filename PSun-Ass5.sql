...
INSERT INTO `assignment` VALUES (1,1,'2025-03-03 07:30:00','2025-03-03 11:30:00'),(2,2,'2025-03-04 10:00:00','2025-03-04 15:00:00');
...
CREATE TABLE `item` (
  ...
  `itemValue` decimal(6,2) DEFAULT NULL,
...
INSERT INTO `item` VALUES (1,'Bandage Set',18.50,120),(2,'Box of Granola Bars',6.75,450);
...
INSERT INTO `package` VALUES (1,2,1,'2025-03-03',4.80),(2,2,2,'2025-03-04',3.60);
...
INSERT INTO `package_contents` VALUES (1,1,12),(2,2,8);
...
INSERT INTO `package_type` VALUES (1,'Medical Supplies'),(2,'Infant Care'),(3,'Non-Perishable Food');
...
INSERT INTO `packing_list` VALUES (1,'Emergency Aid Kit','Includes supplies for first response assistance');
...
INSERT INTO `task` VALUES (1,NULL,1,1,'Assist with phone inquiries and logging requests'),(2,1,2,2,'Organize and distribute 5,000 emergency aid packages');
...
INSERT INTO `volunteer` VALUES (1,'Bucky Barnes','789 Oak St, Greenfield','555-2211'),(2,'Peter Parker','321 Birch Rd, Lakeside','555-3344');
...
-- Dump completed on 2025-03-07  2:12:39
